import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as c,c as p,a as n,b as s,e,f as l}from"./app-da221e1c.js";const o={},r=n("h1",{id:"設定-nginx-用於-php-專案的基本設定",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#設定-nginx-用於-php-專案的基本設定","aria-hidden":"true"},"#"),s(" 設定 Nginx 用於 php 專案的基本設定")],-1),d=n("h2",{id:"可參考設定檔產生網站",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#可參考設定檔產生網站","aria-hidden":"true"},"#"),s(" 可參考設定檔產生網站")],-1),v={href:"https://www.digitalocean.com/community/tools/nginx?global.app.lang=zhTW",target:"_blank",rel:"noopener noreferrer"},u=l(`<h2 id="適用版本" tabindex="-1"><a class="header-anchor" href="#適用版本" aria-hidden="true">#</a> 適用版本</h2><p><code>nginx version: nginx/1.22.1</code></p><h2 id="基本設定" tabindex="-1"><a class="header-anchor" href="#基本設定" aria-hidden="true">#</a> 基本設定</h2><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
